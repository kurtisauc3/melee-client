...
var gamecube_adapter_1 = require("./gamecube-adapter");
var adapter = null;
function createAppWindow() {
    ...
    adapter = new gamecube_adapter_1.GamecubeAdapter();
    adapter.gamecube_input.subscribe(function (data) { return win.webContents.send("gc_input", data); });
    electron_1.app.on('browser-window-focus', function (event, win) {
        adapter.start_adapter();
    });
    electron_1.app.on('browser-window-blur', function (event, win) {
